...
<body class="montserrat-font">
            ...
            <div class="navbar pt-6 flex ">
                ...
                <div class="navbar-center hidden font-medium text-black lg:flex">
                    <ul class="menu menu-horizontal px-1 font-[400]">
                        ...
                        <li class="hover:font-semibold hover:text-blue-600 hover: duration-300 ease-in-out"><a href="./delivery-books.php">Delivery Books</a></li>
                        <li class="hover:font-semibold hover:text-blue-600 duration-300 ease-in-out"><a href="./received-books.php">Retrive Books</a></li>
                ...
                <div class="relative inline-block ">
                    ...
                    <div class="relative text-sm">
                        <button id="userButton" class="flex items-center focus:outline-none gap-1">
                            <span class="hidden md:inline-block text-blue-600 font-semibold">Hi, Rider! </span>
                        ...
                        <div id="userMenu" class="bg-white nunito menu rounded shadow-md absolute overflow-x-auto text-wrap z-30 mt-3 invisible">
                            <ul class="">
                                <li><a href="../../userProfiles/delivery_man/profile.php" class="w-28 text-gray-900 hover:bg-indigo-400 hover:text-white ">My Profile</a></li>
            ...
            <div class=" relative">
                <div class=" rounded-2xl h-auto md:h-96 flex flex-col md:flex-row p-6 gap-4 md:gap-5 items-center">
                    ...
                    <div
                        ...
                        <div>
                            <a href="./index.php" class="text-black bg-blue-400 hover:bg-blue-600 hover:text-white focus:outline-none font-medium rounded-xl text-m px-6 py-3">Explore Now!</a>
                        </div>
                    </div>
    ...
    <section id="sub" class="relative h-[400px] pl-24 bg-cover bg-center" style="background-image: url('../../assets/images/join-bg.jpg');">
    <!-- Overlay -->
