...
<body class="montserrat-font">
    <header class="bg-gradient-to-t from-slate-300 to-slate-100 pb-20">
      <!-- navbar starts here -->
        ...
        <div class="navbar pt-6 flex ">
          ...
          <div class="navbar-center hidden font-medium text-black lg:flex">
            <ul class="menu menu-horizontal px-1 font-[400]">
              <li class="font-semibold hover:text-blue-600 duration-300 ease-in-out"><a href="">Home</a></li>
              <li class="hover:font-semibold hover:text-blue-600 hover: duration-300 ease-in-out"><a href="#main">Browse Books</a></li>
          ...
          <div class="navbar-end">
            <div class="hidden lg:flex gap-2 items-center">
              <div>
                <i class="fa-regular fa-magnifying-glass size-10 border border-solid rounded-full bg-white pl-3 pt-3"></i>
              </div>
              <div>
                <a href="./loginAuth/login.php"><i class="fa-regular fa-user size-10 border border-solid rounded-full bg-white pl-3 pt-3"></i></a>
              </div>
            </div>          
          </div>
        </div>
    ...
    <section class="container mx-auto lg:w-4/5 pt-10">
      <div class=" relative">
        <div class=" rounded-2xl h-auto md:h-96 flex flex-col md:flex-row p-6 gap-4 md:gap-5 items-center">
            ...
            <div
                ...
                <a href="#main" target="_blank" class="inline-block">
                    <button type="button"
...
?>
    ...
    <main class="container mx-auto lg:w-4/5 pt-10" id="main">
      <h1 class="text-2xl pb-8 font-semibold">Featured Books</h1>
      <form action="" method="GET" class="mb-6 flex justify-between">
          <div>
              <a href="index.php#main" class="bg-blue-600 text-white px-3 py-2 rounded-lg hover:bg-blue-700 transition-colors">Show All</a>
          </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          <?php if (isset($result) && mysqli_num_rows($result) > 0): ?>
              <?php while ($row = mysqli_fetch_assoc($result)): ?>
                  <div class="border-2 border-gray-300 shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                      ...
                      <div class="pb-4">
                      <a href="/loginAuth/login.php" class="ml-4 mb-4 px-20 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition-colors">Rent</a>
  ...
  <section id="sub" class="relative h-[400px] mt-8 pl-24 bg-cover bg-center" style="background-image: url('./assets/images/join-bg.jpg');">
    <!-- Overlay -->
